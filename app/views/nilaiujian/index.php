...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <a href="../nilaiujian/create.php" class="btn btn-primary mb-3">Tambah Nilai Ujian Matakuliah</a>
                ...
                <?php if (!empty($nilaiujians) && is_array($nilaiujians)): ?>
                    <?php foreach ($nilaiujians as $nilaiujian): ?>
                        <tr>
                            ...
                            <td>
                                <a href="../nilaiujian/edit.php/<?php echo $nilaiujian['id_nilai']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                <a href="../app/nilaiujian/delete/<?php echo $nilaiujian['id_nilai']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus matakuliah ini?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
