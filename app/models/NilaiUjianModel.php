...
class nilaiUjian {
    ...
    public function create($data) {
        $query = "INSERT INTO data_nilai_ujian (id_matakuliah, nilai_matkul, nim) VALUES (:id_matakuliah, :nilai_matkul, :nim)";
        $this->db->query($query);
    ...
    public function update($data) {
        $query = "UPDATE data_nilai_ujian SET id_matakuliah = :id_matakuliah, nilai_matkul = :nilai_matkul, nim = :nim WHERE id_nilai = :id_nilai";
        $this->db->query($query);
